...
<head>
	...
	<style>
		@charset "utf-8";
		/* CSS Document */
		form{ margin:0px; padding:0px; font-family:Ebrima, Arial, Helvetica, sans-serif; font-size:8px; color:#666; empty-cells:hide;}
		...
		tr.calendar-row  {  }
		td.calendar-day  { min-height:5px; position:relative; } * html div.calendar-day { height:5px; }
		td.calendar-day:hover  { background:#FFF; -moz-box-shadow:0px 0px 5px #eeeeee inset; -webkit-box-shadow:0px 0px 5px #eeeeee inset; box-shadow:0px 0px 5px #eeeeee inset; cursor:pointer;}
		td.calendar-day-np  { background:#eee; min-height:5px; } * html div.calendar-day-np { height:5px; }
		td.calendar-day-head {font-weight:bold; text-shadow:0px 1px 0px #FFF;color:#666; text-align:center; width:4px; padding:3px 2px; border-bottom:1px solid #CCC; border-top:1px solid #CCC; border-right:1px solid #CCC; background: #ffffff;
		...
		/* shared */
		td.calendar-day, td.calendar-day-np {padding:3px; border-bottom:1px solid #DBDBDB; border-right:1px solid #DBDBDB; font-size:14px;background: #ffffff;
		...
		.currentday:hover{-moz-box-shadow:0px 0px 6px #074080 inset !important; -webkit-box-shadow:0px 0px 6px #074080 inset !important; box-shadow:0px 0px 6px #074080 inset !important;}
</style>
</head>
<body>
